...
decoded_candidates = []
unique_decodes = set()
heads = ['Tload+', 'Rx call', 'Tx call', 'GrRp', 'SchScr', 'SyncScr', 't0', 'cfg', 'f0', 'sch_idx']
...
for i, c in enumerate(candidates):
    ...
    if(decode):
        ...
        print(f"{tdelta:8.2f} {dd['call_a']:>8} {dd['call_b']:>8} {dd['grid_rpt']:>8} {c.score_init:8.3f} {c.score:8.3f} {c.origin[0]:>8} {c.iconf:>8} {c.origin[1]:>8} {c.sort_idx_finder:>8}")
