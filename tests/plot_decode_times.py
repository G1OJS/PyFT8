...
plot_from_file(ax, 'live_decode_times_PyFT8_8_28_baseline.pkl', 'PyFT8-baseline', 'green')
plot_from_file(ax, 'live_decode_times_PyFT8_8_28_baseline_new_osd.pkl', 'PyFT8-new-osd', 'limegreen')
