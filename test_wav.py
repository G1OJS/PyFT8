...
cycle_manager = Cycle_manager(FT8, onDecode, onOccupancy = None, audio_in_wav = wav_file, 
                          max_iters = 30, max_stall = 8, max_ncheck = 40, timeout = 1, 
                          sync_score_thresh = 1.8, max_cycles = 1, return_candidate = True)

cycle_manager.PyFT8_decode_manager()
